...
const TEMPLATE_COLUMNS = {
  extrato:   ['LOGIN VENDEDOR','NOME CLIENTE','OPERAÇÃO','PRODUTO','VALOR PRODUTO ATUAL','VALOR APURADO','REGIONAL','TIME','SUPERVISOR','GRUPO COMISSÃO','ESTEIRA','TIPO COMISSÃO'],
  recalculo: ['LOGIN VENDEDOR','NOME CLIENTE','OPERAÇÃO','VALOR RECALCULADO','MOTIVO','COMPETENCIA'],
